## grasping_msgs (rolling) - 0.5.0-1

The packages in the `grasping_msgs` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling -t rolling grasping_msgs` on `Fri, 08 Nov 2024 22:53:40 -0000`
